...
\begin{itemize}
	...
	\item Section \ref{completionstage}: New section for \code{CompletionStage<T>} as return type in a resource method.
	\item Section \ref{provider_priorities}: New section introducing support for \code{@Priority} for all providers.
	\item Section \ref{entity_providers}: Modified algorithm steps to add support for \code{@Priority} in selection of message body readers and writers.
\end{itemize}
