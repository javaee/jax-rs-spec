...
This example first creates an asynchronous computation of type \code{CompletionStage<String>}, and then a secondary of type \code{CompletionStage<Void>} on the last line; the purpose of the latter one is simply to wait on the former to complete and print its value. 
